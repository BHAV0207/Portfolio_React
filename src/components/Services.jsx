    ...
    return(
        <div className="bg-[#1f2235]">
            <div className="text-center mb-[5rem]">
                <div><h1 className="text-4xl font-bold font-serif mt-[10rem]">Offering To My Clints</h1></div>
            ...
            <div className="flex place-content-between mr-[13rem] ml-[13rem]">
                <div className="bg-[#272A3F] flex flex-col ml-[5rem] mr-[5rem] p-8">
                    <div><i class="fa-regular fa-file fa-2xl hover:text-red-500 transition-colors duration-400"></i></div>
                    <div><h1 className="text-xl mt-[1rem]">FRONT END WEB APP</h1></div>
                    <div><p className="mt-[0.5rem]">I can make a Fully responsive front end web application with react and next.js for server side rendering with Tailwind</p></div>
                </div>
                <div className="bg-[#272A3F] flex flex-col mr-[5rem] p-8">
                    <div><i class="fa-regular fa-file fa-2xl hover:text-red-500 transition-colors duration-400"></i></div>
                    <div><h1 className="text-xl mt-[1rem]">E-COMMERCE WEB APP</h1></div>
                    <div><p className="mt-[0.5rem]">I will build e-commerce web application with React, Redux, MongoDB and SSLCOMMERZ Payment Gateway</p></div>
                </div>
                <div className="bg-[#272A3F] flex flex-col mr-[5rem] p-8">
                    <div><i class="fa-regular fa-file fa-2xl hover:text-red-500 transition-colors duration-400"></i></div>
